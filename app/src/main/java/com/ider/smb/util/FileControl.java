...
public class FileControl {
	...
	private void fill(File files) {
		...
		if(mainActivity.mWaitDialog != null){
			mainActivity.mWaitDialog.setCancelable(true);
		}
	...
	public void refill(String path){
		...
		if( currently_path.equals(EnumConstent.mDirSmb))
			currently_parent = null;
		else{
			if(files.getParent().equals(EnumConstent.mDirSmbMoutPoint)){
				currently_parent = new File(mainActivity.mCurrnetSmb).getParent();
			}else{
...
//		}
	...
	void first_fill(){
		is_first_path = true;
		folder_array = new ArrayList<FileInfo>();
		mainActivity = (MainActivity)context_by;
